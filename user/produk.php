...
<body>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="https://api.whatsapp.com/send?phone=08990704906 &text=Hai, saya tertarik dan ingin memesan produk <?= $rows['product_name']; ?> dengan nomor produk <?= $rows['product_id']; ?>" target="_blank" class="btn btn-success" style="text-decoration:none;"><i class="fa-brands fa-whatsapp mr-1"></i>Hubungi via Whatsapps</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="copyright text-center text-white font-weight-bold bg-warning p-3">
    <p>© 2025 - By N2Y STORE Rights Reserved.</p>
  </div>
