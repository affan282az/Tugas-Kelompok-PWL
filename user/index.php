...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand font-weight-bold" href="../admin/index.php">N2Y STORE</a>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="https://wa.me/08990704906?text=Hai,%20saya%20tertarik%20dan%20ingin%20memesan%20produk%20<?= $rows['product_name']; ?>%20dengan%20nomor%20produk%20<?= $rows['product_id']; ?>" target="_blank" class="btn btn-success" style="text-decoration:none;"><i class="fa-brands fa-whatsapp mr-1"></i>Hubungi via Whatsapps</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="bg-dark text-white p-5">
    <div class="row">
      ...
      <div class="col-md-3">
        <h5>TENTANG KAMI</h5>
        <p>Kami adalah reseller online terpeceraya
        </p>
      </div>
      <div class="col-md-3">
  ...
  <div class="copyright text-center text-white font-weight-bold bg-warning p-3">
    <p>© 2025 - By N2Y STORE All Rights Reserved.</p>
  </div>
